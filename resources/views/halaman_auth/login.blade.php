...
<body style="background-color: #383434;">

    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form action="{{ route('auth') }}" style="background-color: #fcefef;" class="login100-form validate-form" method="POST">
                    @csrf
                    ...
                    <div class="d-grid gap-2 col-3 mx-auto">
                        <a href="{{ route('registrasi') }}" class="btn btn-primary">Register</a>
                    </div>

                </form>

                <div class="login100-more"
                    style="background-image: url('{{ asset('halaman_auth/images/bg-02.png') }}');">
                </div>
            </div>
        </div>
    </div>
